...
function HeartIcon({ size = 24, className = '' }) {
  return (
    ...
    >
      <path
        d="M24 41.5S8 30.5 8 18.5C8 13.2533 12.2533 9 17.5 9C20.738 9 23.596 10.625 25.258 13.208C26.576 10.792 29.578 9 33.5 9C38.7467 9 43 13.2533 43 18.5C43 30.5 24 41.5 24 41.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M14 22H19L22 14L27 32L30 22H34"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const modules = [
    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Defined as the acquisition, interpretation, and clinical integration of ultrasonographic imaging performed by a treating clinician at the patient’s bedside rather than by another healthcare provider.',
          },
          {
            type: 'text',
            text: 'POCUS is an inclusive term; it is not limited to any specialty, protocol, or organ system.',
          },
        ],
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'The ultrasound probe is what we use to see into the body. There are three main probes that we use:',
          },
          { type: 'bold', text: 'Curvilinear (Abdominal)' },
          {
            ...
            items: [
              'Low frequency probe',
              'Used for: free fluid in abdomen and pelvis, bladder, kidneys, lung ultrasound, AAA)',
            ],
          },
          { type: 'bold', text: 'Phased Array (Cardiac)' },
          {
            type: 'list',
            items: [
              'Low frequency probe that specializes in cardiac movement',
              'Used for: cardiac scans, lung ultrasound',
            ],
          },
          { type: 'bold', text: 'Linear (Vascular)' },
          {
            ...
            items: [
              ...
              'Used for: seeing things close to the surface (lung sliding, vessels, skin, superficial joints)',
            ],
          },
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%202%20-%20Probes%20Real.png',
            caption: 'Ultrasound Probes',
          },
          {
            type: 'info',
            text: (
              <>
                Low frequency probes have high penetration but low resolution{' '}
                <strong>(you can see far but not very well)</strong>
              </>
            ),
          },
          {
            ...
            text: (
              <>
                High frequency probes have low penetration but high resolution{' '}
                <strong>(you can see well but not very far)</strong>
              </>
            ),
          },
          { type: 'divider' },
          {
            type: 'text',
            text: 'Sound travels from the probe into the body. Some sound is lost as heat or scattered away. Some sound reflects back to our probe. The sound that reflects back to the probe is interpreted by our machine and an image is displayed on our screen.',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%201%20-%20Making%20an%20Image%202.mp4',
            caption: 'How an Ultrasound Image is Made',
          },
        ],
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'The images acquired during various POCUS applications will generally be acquired in 1 of 2 longitudinal planes and/or the transverse plane of the body. Conversely, we are sometimes interested in acquiring an image demonstrating the long or short axis of a particular structure.',
          },
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%203%20-%20Anatomical%20Planes%202.png',
            caption: 'Anatomical Planes',
          },
          {
            type: 'label',
            label: 'Long Axis:',
            text: 'Plane parallel to the maximum length of a structure',
          },
          {
            type: 'label',
            label: 'Short Axis:',
            text: 'Plane perpendicular to the maximum length of a structure',
          },
        ],
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'There are 5 standard ways an ultrasound probe can be moved.',
          },
          { type: 'bold', text: 'Sliding:' },
          {
            type: 'text',
            text: 'Moving the probe about its long or short axis while keeping the angle between your probe and your structure (angle of insonation) constant.',
          },
          {
            type: 'text',
            text: 'Sliding is sometimes referred to as translating.',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%204%20-%20Probe%20Movements%20-%20Sliding.mp4',
            caption: 'Sliding the Probe',
          },
          { type: 'bold', text: 'Fanning:' },
          {
            type: 'text',
            text: 'Keeping the probe on a fixed point while changing the angle of insonation along the short axis of the probe.',
          },
          {
            type: 'text',
            text: 'Fanning is sometimes referred to as tilting or sweeping.',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%205%20-%20Probe%20Movements%20-%20Fanning.mp4',
            caption: 'Fanning the Probe',
          },
          { type: 'bold', text: 'Rocking:' },
          {
            type: 'text',
            text: 'Keeping the probe on a fixed point while changing the angle of insonation along the long axis of the probe.',
          },
          {
            type: 'text',
            text: 'Rocking is sometimes referred to as angling or heel-toeing.',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%206%20-%20Probe%20Movements%20-%20Rocking.mp4',
            caption: 'Rocking the Probe',
          },
          { type: 'bold', text: 'Rotating:' },
          {
            type: 'text',
            text: 'Keeping the probe on a fixed point while moving clockwise or counter clockwise',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%207%20-%20Probe%20Movements%20-%20Rotating.mp4',
            caption: 'Rotating the Probe',
          },
          { type: 'bold', text: 'Compression:' },
          {
            type: 'text',
            text: 'Applying pressure to the body on a fixed point with the probe',
          },
          { type: 'divider' },
          {
            type: 'text',
            text: 'The ultrasound probe is moved with respect to standard anatomic directions: (slide anteriorly, rock cranially)',
          },
          {
            type: 'text',
            text: 'Probe movements are always made with respect to where the sound is moving, not where the probe is moving: (rocking cranially means the sound coming out of the probe will be travelling cranially while the majority of the probe will be moving caudally)',
          },
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%208%20-%20Anatomical%20Directions%203.png',
      ...
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'Convention = the agreed upon way we do something (reading left to right, driving on the right side of the road)',
          },
          {
            type: 'text',
            text: 'Conventions for the same task can differ between groups (some places drive on the left side of the road).',
          },
          ...
          { type: 'bold', text: 'Radiology Convention' },
          {
            type: 'list',
            items: [
              'Screen marker appears on screen LEFT',
              'Used for all POCUS applications except cardiac',
            ],
          },
          { type: 'bold', text: 'Cardiology Convention' },
          {
            type: 'list',
            items: [
              'Screen marker appears on screen RIGHT',
              'Used for Cardiac POCUS',
            ],
          },
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%209%20-%20Conventions%202.png',
            caption: 'Ultrasound Imaging Conventions',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/POCUS%20Basics/Media%2010%20-%20Screen%20Anatomy.mp4',
            caption: 'Screen Anatomy',
          },
        ],
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: 'If you didn’t document it in the patient’s chart, it didn’t happen.',
          },
          {
            type: 'list',
            items: [
        ...
        content: [
          ...
          { type: 'subheader', text: 'Equipment' },
          {
            ...
            items: [
              ...
              'Preset: Abdominal',
              'Convention: Radiology',
            ],
          },
          { type: 'subheader', text: 'Patient Positioning' },
          {
            type: 'list',
            items: ['Supine | Semi-Supine', 'Arm above head or across body'],
          },
          { type: 'divider' },
          { type: 'header', text: 'Landmarks' },
          {
            type: 'bold',
            text: 'Right Upper Quadrant (RUQ) | Left Upper Quadrant (LUQ)',
          },
          {
            type: 'text',
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%201%20-%20RUQ%20LUQ%20External%20Landmarks.png',
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%202%20-%20RUQ%20Internal%20Landmarks.mp4',
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%203%20-%20LUQ%20Internal%20Landmarks.mp4',
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%204%20-%20Pelvis%20Probe%20Starting%20Position.png',
            caption: 'Pelvis Probe Starting Position',
          },
          { type: 'bold', text: 'Pelvis Male' },
          {
            type: 'text',
            text: 'Internal: Bladder | Prostate | Seminal Vesicles | Rectum',
          },
          {
            type: 'video',
          ...
          {
            type: 'text',
            text: 'Internal: Bladder | Uterus | Vagina | Rectum',
          },
          {
            type: 'video',
          ...
          {
            type: 'text',
            text: 'Splenorenal Interface | Between Diaphragm and Spleen',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%207%20-%20RUQ%20LUQ%20Area%20of%20Interest.mp4',
            caption: 'RUQ and LUQ Areas of Interest',
          },
          { type: 'bold', text: 'Pelvis Male' },
          { type: 'text', text: 'Rectovesicular Space' },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%208%20-%20Male%20Pelvis%20Transverse%20Longitudinal%20Area%20of%20Interest.mp4',
            caption: 'Male Pelvis Area of Interest',
          },
          { type: 'bold', text: 'Pelvis Female' },
          {
            type: 'text',
            text: 'Rectouterine Space (Pouch of Douglas) | Vesicouterine Space',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%209%20-%20Female%20Pelvis%20Transverse%20Longitudinal%20Area%20of%20Interest.mp4',
            caption: 'Female Pelvis Area of Interest',
          },
        ],
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'image',
            url: '',
            caption: 'Media 10 - RUQ Probe Starting Position (Coming Soon)',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2011%20-%20RUQ%20Fanning%20Interface.mp4',
            caption: 'RUQ Fanning Through Hepatorenal Interface',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2012%20-%20RUQ%20Fanning%20Caudal%20Tip%20of%20Liver.mp4',
            caption: 'RUQ Fanning Through Caudal Tip of Liver',
          },
          ...
          {
            type: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2013%20-%20LUQ%20Probe%20Placement.png',
            url: '',
            caption: 'LUQ Starting Position',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2014%20-%20LUQ%20Fanning%20Interface%20and%20Medial%20Diaphragm.mp4',
            caption:
              'LUQ Fanning Through Splenorenal Interface and Medial Diaphragm',
          },
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2015%20-%20Pelvis%20Transverse%20Probe%20Starting%20Position.png',
            caption: 'Pelvis Transverse Initial Probe Placement',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2016%20-%20Male%20Pelvis%20Transverse%20Fanning.mp4',
            caption: 'Male Pelvis Transverse Fanning',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2017%20-%20Female%20Pelvis%20Transverse%20Fanning.mp4',
            caption: 'Female Pelvis Transverse Fanning',
          },
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2018%20-%20Pelvis%20Longitudinal%20Probe%20Starting%20Position.png',
            caption: 'Pelvis Longitudinal Initial Probe Placement',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2019%20-%20Male%20Pelvis%20Longitudinal%20Fanning.mp4',
            caption: 'Male Pelvis Longitudinal Fanning',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2020%20-%20Female%20Pelvis%20Longitudinal%20Fanning.mp4',
            caption: 'Female Pelvis Longitudinal Fanning',
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Anechoic free fluid seen in hepatorenal interface or around the caudal tip of the liver',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2021%20-%20RUQ%20Positive%20Scan%20Free%20Fluid%20Large%20Amount.mp4',
            caption: 'RUQ Positive Scan Large Amount of Free Fluid',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2022%20-%20RUQ%20Positive%20Scan%20Small%20Amount%20Caudal%20Tip.mp4',
            caption:
              'RUQ Positive Scan Small Amount of Free Fluid at Caudal Tip of Liver',
          },

          { type: 'bold', text: 'LUQ' },
          {
            type: 'text',
            text: 'Anechoic free fluid seen in splenorenal interface or between medial diaphragm and spleen',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2023%20-%20LUQ%20Positive%20Scan%20Free%20Fluid%20Large%20Amount.mp4',
            caption: 'LUQ Positive Scan Large Amount of Free Fluid',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2024%20-%20LUQ%20Positive%20Scan%20Free%20Fluid%20Small%20Amount.mp4',
            caption: 'LUQ Positive Scan Small Amount of Free Fluid',
          },

          { type: 'bold', text: 'Pelvis Male' },
          {
            type: 'text',
            text: 'Anechoic free fluid seen in the rectovesicular space',
          },
          {
            type: 'video',
            url: '',
            caption:
              'Media 25 - Male Pelvis Transverse Positive Scan Free Fluid (Coming Soon)',
          },
          {
            type: 'video',
            url: '',
            caption:
              'Media 26 - Male Pelvis Longitudinal Positive Scan Free Fluid (Coming Soon)',
          },

          { type: 'bold', text: 'Pelvis Female' },
          {
            type: 'text',
            text: 'Anechoic free fluid seen in the rectouterine space and/or the vesicouterine space',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2027%20-%20Female%20Pelvis%20Transverse%20Positive%20Scan%20Free%20Fluid.mp4',
            caption: 'Female Pelvis Transverse Positive Scan Free Fluid',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Free%20Fluid%20Abdomen/Media%2028%20-%20Female%20Pelvis%20Longitudinal%20Positive%20Scan%20Free%20Fluid.mp4',
            caption: 'Female Pelvis Longitudinal Positive Scan Free Fluid',
          },
          ...
          {
            type: 'text',
            text: 'No anechoic free fluid after fanning through entire hepatorenal interface anterior to posterior AND no anechoic free fluid around the caudal tip of the liver after fanning through the caudal tip anterior to posterior. (See scanning technique clips)',
          },

          { type: 'bold', text: 'LUQ' },
          {
            type: 'text',
            text: 'No anechoic free fluid after fanning through entire splenorenal interface anterior to posterior AND no anechoic free fluid between the medial diaphragm and spleen after fanning through the medial diaphragm until it disappears. (See scanning technique clips)',
          },

          { type: 'bold', text: 'Pelvis Male' },
          {
            type: 'text',
            text: 'No anechoic free fluid seen in the rectovesicular space after fanning through the bladder in both transverse and longitudinal. (See scanning technique clips)',
          },

          { type: 'bold', text: 'Pelvis Female' },
          {
            type: 'text',
            text: 'No anechoic free fluid seen in the rectouterine and vesicouterine space after fanning through the bladder in both transverse and longitudinal. (See scanning technique clips)',
          },
        ],
      },
      {
        ...
        content: [
          { type: 'bold', text: 'Rib shadows' },
          {
            type: 'list',
            items: [
              'Rotate probe toward bed into rib space',
              'Have patient take a breath in and hold to move structure out from under rib',
            ],
          },
  ...
  },
  {
    ...
    description: 'Scanning for pleural effusion.',
    ...
    sections: [
      {
        ...
        content: [
          ...
          { type: 'subheader', text: 'Equipment' },
          {
            type: 'list',
            items: [
              'Transducer: Curvilinear | Phased Array',
              'Preset: Abdominal',
              'Convention: Radiology',
            ],
          },
          { type: 'subheader', text: 'Patient Positioning' },
          {
            type: 'list',
            items: [
              'Supine | Semi-Supine | Sitting',
              'Arm above head or across body',
            ],
          },
          { type: 'divider' },
          { type: 'header', text: 'Landmarks' },
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pleural%20Effusion/Media%203%20-%20Starting%20view%20before%20fanning.mp4',
            caption: 'Starting view before fanning',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pleural%20Effusion/Media%204%20-%20Fanning%20Through%20Medial%20Diaphragm.mp4',
            caption: 'Fanning Through Medial Diaphragm',
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Anechoic area seen cranial to the diaphragm and ≥ 1 of the following:',
          },
          {
            type: 'list',
            items: [
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pleural%20Effusion/Media%205%20-%20Positive%20Scan%20-%20Large%20Pleural%20Effusion%20and%20Solid%20Lung.mp4',
            caption: 'Positive Scan - Large Pleural Effusion and Solid Lung',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pleural%20Effusion/Media%206%20-%20Positive%20Scan%20-%20Small%20Pleural%20Effusion.mp4',
            caption: 'Positive Scan - Small Pleural Effusion',
          },
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pleural%20Effusion/Media%207%20-%20Curtain%20Sign.mp4',
            caption: 'Curtain sign',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    title: 'Pneumothorax',
    description:
      'Evaluating for lung sliding, physiologic lung points, and pathologic lung points.',
    ...
    sections: [
      {
        ...
        content: [
          ...
          { type: 'subheader', text: 'Equipment' },
          {
            type: 'list',
            items: [
              'Transducer: Linear | Curvilinear (EFAST)',
              'Preset: Lung | Abdominal',
              'Convention: Radiology',
            ],
          },
          { type: 'subheader', text: 'Patient Positioning' },
          ...
          {
            type: 'text',
            text: 'External: Most Anterior Aspect of Chest | Mid-Clavicular Line',
          },
          {
            type: 'text',
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%202%20-%20Internal%20Landmarks.mp4',
            caption: 'Internal Landmarks',
          },
          { type: 'divider' },
          { type: 'header', text: 'Area of Interest' },
          {
            type: 'text',
            text: 'VPPI of 2-3 of the most anterior rib spaces bilaterally',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%203%20-%20Area%20of%20Interest.mp4',
            caption: 'Area of Interest',
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%204%20-%20Negative%20Scan%20Lung%20Sliding.mp4',
            caption: 'Negative Scan Lung Sliding',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%205%20-%20Negative%20Scan%20Lung%20Pulse.mp4',
            caption: 'Negative Scan Lung Pulse',
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Absence of lung sliding, lung pulse, and B-lines PLUS visualization of a pathological lung point',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%206%20-%20No%20Lung%20Sliding.mp4',
            caption: 'No Lung Sliding',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%207%20-%20Pathologic%20Lung%20Point.mp4',
            caption: 'Pathologic Lung Point',
          },
          ...
          { type: 'header', text: 'Negative Scan:' },
          {
            ...
            items: [
              <>
                Lung sliding present in 2-3 of the most anterior rib spaces
                bilaterally (see scanning technique) <strong>OR</strong>
              </>,
              <>
                Lung pulse present in 2-3 of the most anterior rib spaces
                bilaterally (see scanning technique) <strong>OR</strong>
              </>,
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'bold',
            text: 'Differentiating Pathologic From Physiologic Lung Points',
          },
          {
            type: 'list',
            items: [
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%208%20-%20Physiologic%20Lung%20Point%20Cardiac%20Lung%20Point.mp4',
            caption: 'Physiologic Lung Point - Cardiac Lung Point',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Pneumothorax/Media%209%20-%20Physiologic%20Lung%20Point%20Liver%20Lung%20Point.mp4',
            caption: 'Physiologic Lung Point - Liver Lung Point',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    description: 'Evaluating for B-lines in lung zones.',
    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'External: Parasternal Line | Midclavicular Line | Anterior Axillary Line | Posterior Axillary Line | Inter-Nipple Line',
          },
          {
            type: 'text',
            text: 'Internal: Visceral Parietal Pleural Interface (VPPI) | Ribs | Rib Shadows | A-lines (if present)',
          ...
          {
            type: 'image',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%201%20-%20Lung%20Zones.png',
            caption: 'Lung Zones',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%202%20-%20Internal%20Landmarks.mp4',
            caption: 'Internal Landmarks',
          },
          { type: 'divider' },
          { type: 'header', text: 'Area of Interest' },
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%203%20-%20Sliding%20to%20center%20the%20VPPI.mp4',
            caption: 'Sliding to center the VPPI',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%204%20-%20Fanning%20to%20optimize%20VPPI.mp4',
            caption: 'Fanning to optimize VPPI',
          },
          {
            type: 'bold',
            text: 'Repeat above technique for the opposite hemithorax.',
          },
        ],
      },
      {
        ...
        content: [
          { type: 'header', text: 'Positive Scan' },
          {
            ...
            text: (
              <>
                ≥ 3 B-lines present in a single rib space at any time throughout
                the respiratory cycle <strong>OR</strong> coalescing B-lines
              </>
            ),
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%205%20-%20B-Lines.mp4',
            caption: 'B-Lines',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%206%20-%20Coalescing%20B-Lines.mp4',
            caption: 'Coalescing B-Lines',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%207%20-%20Coalescing%20B-Lines%20Making%20White%20Lung.mp4',
            caption: 'Coalescing B-Lines Making White Lung',
          },
          ...
          {
            type: 'text',
            text: '< 3 B-lines present in a single rib space at any time throughout the respiratory cycle',
          },
          {
            type: 'video',
            url: 'https://pub-2cf3bcb92e72473dac171762929cd457.r2.dev/Interstitial%20Syndromes/Media%208%20-%20Normal%20A-Lines.mp4',
            caption: 'Normal A-Lines',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    title: 'Cardiac',
    description:
      'Evaluating for pericardial effusion, LV/RV systolic function, and RV size.',
    icon: HeartIcon,
    color: 'rose',
    sections: [
      {
        ...
        content: [
          ...
          {
            type: 'list',
            items: ['Supine | Semi-Supine | Left Lateral Decubitus'],
          },
          ...
          {
            type: 'text',
            text: 'External: Left Sternal Border | Rib Spaces 2-5',
          },
          {
            type: 'text',
          ...
          {
            type: 'text',
            text: 'External: Midline | Between Umbilicus and Xiphoid Process',
          },
          {
            type: 'text',
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'bold',
            text: 'RV Enlarged \\ RV Systolic Function Reduced:',
          },
          ...
          {
            type: 'bold',
            text: 'RV Normal Size \\ RV Systolic Function Normal:',
          },
          { type: 'label', label: 'PLAX:' },
          {
            type: 'sublist',
      ...
      },
      {
        ...
        content: [
          {
            type: 'bold',
            text: 'Distinguishing a pericardial effusion from a pleural effusion:',
          },
          {
            type: 'sublist',
            items: [
          ...
          {
            type: 'bold',
            text: 'Distinguishing a pericardial effusion from an epicardial pad in the SC view:',
          },
          {
            type: 'sublist',
            items: [
  ...
  },
  {
    ...
    description:
      'Scanning for hydronephrosis, ureteric jets, and evaluating bladder volume.',
    icon: KidneyIcon,
    color: 'sky',
    sections: [
      {
        ...
        content: [
          ...
          { type: 'subheader', text: 'Patient Positioning' },
          {
            type: 'list',
            items: [
              'Supine | Semi-Supine | Lateral Decubitus',
              'Arm above head or across body',
            ],
          },
          { type: 'divider' },
          ...
          {
            type: 'text',
            text: 'Internal: Kidney | Diaphragm | Liver | Spine',
          },
          {
            type: 'video',
          ...
          {
            type: 'text',
            text: 'Internal: Kidney | Diaphragm | Spleen | Spine',
          },
          {
            type: 'video',
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'text',
            text: 'Bladder Volume (mL) = Anterior-Posterior (AP) x Left-Right/Transverse (TRV) x Cranial-Caudal (cc) x 0.7 (correction factor)',
          },
          {
            type: 'image',
